<template>
    <div class="container w-3/5">
        ...
        <div class="mb-2 border border-2 border-blue-300">
            <input type="text" class="w-full p-2 bg-gray-400 text-black" v-model="title">                  
        </div>
        <div class="mb-2 border border-2 border-blue-300">
            <div>
                <textarea rows="15" placeholder="詳しく書いてください。" v-model="description"
                    class="w-full bg-gray-400 text-black p-2"></textarea>                    
            </div>
        </div>
        <div class="grid grid-cols-2 border border-2 border-blue-300 mb-2 p-2">
            ...
            <div v-if="schedule === 'pattern'">
                ...
                <div v-if="pattern === 'weekly'">
                    ...
                    <select class="bg-gray-400 text-black   " v-model="day">
            ...
            <div v-if="schedule === 'deadline'">
                ...
                <input type="date" id="date" v-model="deadline" class="border border-1 border-dark ml-2 bg-gray-400 text-black">
            </div>
        </div>
